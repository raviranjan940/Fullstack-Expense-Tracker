...
import { Mail, Lock, User, TrendingUp, Loader2 } from "lucide-react";
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 bg-gradient-to-br from-background via-accent/20 to-background">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <Card className="relative border-border/60 shadow-2xl shadow-primary/5 backdrop-blur-sm">
          <CardHeader className="space-y-3 pb-4">
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-lg bg-primary flex items-center justify-center shadow-md">
                <TrendingUp className="h-5 w-5 text-primary-foreground" />
              </div>
              <span className="font-bold text-xl text-foreground">Spendly<span className="text-primary">.</span></span>
            </div>
            <CardTitle className="text-2xl font-bold text-foreground">
              {loginForm ? "Welcome back" : "Create your account"}
            </CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            >
              ...
              {loading ? "Loading..." : `${loginForm ? "Sign In" : "Sign Up"} with Google`}
            </Button>
